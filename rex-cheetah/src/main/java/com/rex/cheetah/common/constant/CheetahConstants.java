package com.rex.cheetah.common.constant;
...
public class CheetahConstants {    
    ...
    public static final String HOST_PARAMETER_NAME = "CheetahHost";
    public static final String PORT_PARAMETER_NAME = "CheetahPort";
    public static final String REGISTRY_ADDRESS_PARAMETER_NAME = "CheetahRegistryAddress";
