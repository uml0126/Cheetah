...
import com.rex.cheetah.protocol.ClientInterceptor;
...
public class ReferenceFactoryBean extends AbstractFactoryBean implements BeanClassLoaderAware {
    ...
    protected void registerReference() throws Exception {
        ...
        if (referenceConfig == null) {
            ...
            referenceConfig.setSecretKey(properties.getString(CheetahConstants.SECRET_KEY_ATTRIBUTE_NAME));
            referenceConfig.setVersion(properties.getInteger(CheetahConstants.VERSION_ATTRIBUTE_NAME));
