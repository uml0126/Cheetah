...
import com.rex.cheetah.common.entity.UserType;
...
public class ZookeeperRegistryExecutor extends CheetahDelegateImpl implements RegistryExecutor {
    ...
    public String retrieveProperty(ApplicationEntity applicationEntity) throws Exception {
        ...
        if (ArrayUtils.isNotEmpty(data)) {
            ...
            String property = new String(data, CheetahConstants.ENCODING_FORMAT);
    ...
    public void persistUser(UserEntity userEntity) throws Exception {
        ...
        if ((StringUtils.equals(name, CheetahConstants.USER_ADMIN_NAME) && type != UserType.ADMINISTRATOR) || (!StringUtils.equals(name, CheetahConstants.USER_ADMIN_NAME) && type == UserType.ADMINISTRATOR)) {
    ...
    public void deleteUser(UserEntity userEntity) throws Exception {
        ...
        String name = userEntity.getName();
        if (StringUtils.equals(name, CheetahConstants.USER_ADMIN_NAME)) {
    ...
    public void resetApplication(ApplicationEntity applicationEntity) throws Exception {  
        ...
        frequencyInvocation.setParameters(new Object[] {properties.getInteger(CheetahConstants.FREQUENCY_ATTRIBUTE_NAME)});
    ...
    public void resetService(String interfaze, ApplicationEntity applicationEntity) throws Exception {                                
        ...
        scretKeyInvocation.setParameters(new Object[] {properties.getString(CheetahConstants.SECRET_KEY_ATTRIBUTE_NAME)});
        ...
        versionInvocation.setParameters(new Object[] {properties.getInteger(CheetahConstants.VERSION_ATTRIBUTE_NAME)});
        ...
        tokenInvocation.setParameters(new Object[] {properties.getLong(CheetahConstants.TOKEN_ATTRIBUTE_NAME)});        
    ...
    public StringBuilder createRootPath() {        
        ...
        builder.append("/");
        builder.append(StringUtils.isEmpty(namespace) ? properties.getString(CheetahConstants.NAMESPACE_ELEMENT_NAME) : namespace);
    ...
    public StringBuilder createApplicationCategoryPath() {
        StringBuilder builder = createRootPath();
        builder.append("/");
        builder.append(CheetahConstants.APPLICATION_ELEMENT_NAME);
    ...
    public StringBuilder createServiceCategoryPath(String application, String group) {
        StringBuilder builder = createApplicationPath(application, group);
        builder.append("/");
        builder.append(CheetahConstants.SERVICE_ELEMENT_NAME);
    ...
    public StringBuilder createReferenceCategoryPath(String application, String group) { 
        StringBuilder builder = createApplicationPath(application, group);
        builder.append("/");
        builder.append(CheetahConstants.REFERENCE_ELEMENT_NAME);
    ...
    public StringBuilder createConfigurationCategoryPath() {        
        StringBuilder builder = createRootPath();
        builder.append("/");
        builder.append(CheetahConstants.CONFIGURATION_ELEMENT_NAME);
    ...
    public StringBuilder createMonitorCategoryPath() {        
        StringBuilder builder = createRootPath();
        builder.append("/");
        builder.append(CheetahConstants.MONITOR_ELEMENT_NAME);
    ...
    public StringBuilder createUserCategoryPath() {        
        StringBuilder builder = createRootPath();
        builder.append("/");
        builder.append(CheetahConstants.USER_ELEMENT_NAME);
