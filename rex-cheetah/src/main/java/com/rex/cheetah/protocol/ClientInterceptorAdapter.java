...
import com.rex.cheetah.common.entity.ResponseAsyncEntity;
import com.rex.cheetah.common.entity.ResponseSyncEntity;
import com.rex.cheetah.common.promise.PromiseContext;
import com.rex.cheetah.common.promise.PromiseEntity;

public class ClientInterceptorAdapter extends CheetahDelegateImpl {
    ...
    public void persistAsync(ProtocolRequest request, MethodEntity methodEntity) {
        ...
        long scan = properties.getLong(CheetahConstants.ASYNC_SCAN_ATTRIBUTE_NAME);
